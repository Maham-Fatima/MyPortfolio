...
export default function Home() {
  return (
    ...
    <div className="absolute top-0 left-0 w-[50%] h-[50%] border-t-4 border-l-4 border-yellow-500 rounded-full"></div>
    <div className="absolute bottom-0 right-0 w-[80%] h-[80%] border-b-4 border-r-4 border-yellow-600 rounded-full"></div>
    <div className="absolute top-0 right-0 w-[70%] h-[70%] border-t-4 border-l-4 border-cyan-400 rounded-full"></div>
    <div className="absolute bottom-0 left-0 w-[50%] h-[50%] border-b-4 border-r-4 border-cyan-600 rounded-full"></div>
